...
fn test_style_box_shadow_inset() {
  let container = ContainerNode {
    style: Style {
      width: Percentage(100.0),
      height: Percentage(100.0),
      background_color: Some(Color::Rgb(0, 0, 255)), // Blue background container for contrast
      ..Default::default()
    },
    children: Some(vec![
      ContainerNode {
        style: Style {
          width: Px(120.0),
          height: Px(80.0),
          background_color: Some(Color::Rgb(255, 255, 255)), // White child for inset visibility
          inheritable_style: InheritableStyle {
