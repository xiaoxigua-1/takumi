...
Takumi comes with pre-bundled fonts [Geist](https://vercel.com/font) and [Geist Mono](https://vercel.com/font) for `@takumi-rs/core` or you can compile with `embed_fonts` feature. This is to minimize the binary size for embedded Takumi versions.
