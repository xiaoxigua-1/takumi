...
<Callout>
This guide is for people plan to use Takumi in Next.js, if you are looking for WASM bindings, check out [Use Takumi in Browser](/docs/getting-started/wasm-web) instead.
</Callout>
