...
<Cards>
<Card title="Getting Started" url="/docs/getting-started" icon={<BookOpen />}>
  Learn how to use Takumi for image generation in various environments.
</Card>
<Card title="From Next.js ImageResponse" url="/docs/migration/migrate-from-image-response" icon={<ArrowBigRight />}>
